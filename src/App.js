...
function App() {
    ...
    return nodeIds
      .map((nodeId) => {
        ...
        const filteredParams = Object.fromEntries(
          Object.entries(node.data.params).filter(([_, v]) => v !== "")
        );
  ...
  const handleDeploy = async () => {
    try {
      ...
      setDebugLogs(prev => [...prev, `Actual workflow name: ${actualWorkflowName}`]);
  ...
  async function monitorWorkflow(client, workflowName) {
    ...
    while (Date.now() - startTime < timeout) {
      ...
      try {
        ...
        if (typeof currentStatus === 'string' && currentStatus.toLowerCase().includes("succeeded")) {
          setDebugLogs(prev => [...prev, "Workflow completed successfully!"]);
          toast.success("Workflow succeeded!");
          return;
        }
  
        if (typeof currentStatus === 'string' && currentStatus.toLowerCase().includes("failed")) {
        ...
        setDebugLogs(prev => [...prev, `Status check error: ${error.message}`]);
  ...
  return (
    <div className="app-container" style={{ display: "flex", width: "100vw", height: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <h1 style={{ fontSize: '1.4rem', fontWeight: 600, margin: 0, color: '#333' }}>ICMR Workflow Designer</h1>
        </div>
      ...
      >
        <h3 style={{ marginBottom: "20px", fontSize: "16px", fontWeight: 600, color: "#333" }}>Node Palette</h3>
        ...
        >
          ...
          >
            <h3 style={{ margin: 0, fontSize: "18px", fontWeight: 600, color: "#333" }}>
              <span style={{ marginRight: "10px" }}>{selectedNode.data.icon}</span>
          ...
          >
            <h4
              style={{ marginTop: 0, marginBottom: "20px", fontSize: "16px", fontWeight: 500, color: "#444" }}
            >
              Node Parameters
            </h4>
            <form
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <span style={{ fontSize: "13px", fontWeight: "bold" }}>Debug Console</span>
              {workflowStatus && (
                <span
                  style={{
                    fontSize: "12px",
                    ...
                    borderRadius: "10px",
                    backgroundColor: 
                      workflowStatus.toLowerCase().includes("succeeded") ? "#4caf50" :
                      workflowStatus.toLowerCase().includes("failed") ? "#f44336" :
                      "#2196f3",
                    color: "white",
                    marginLeft: "10px",
                  }}
      ...
      {showConfigModal && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ marginTop: 0, marginBottom: "20px", fontSize: "18px", fontWeight: 600 }}>Argo Configuration</h2>
