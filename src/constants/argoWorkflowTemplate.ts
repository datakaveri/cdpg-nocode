import { env } from "../environments/environments.ts";
import { ArgoWorkflowTemplate } from "../types/common.type.ts";

export const argoWorkflowTemplate: ArgoWorkflowTemplate = {
